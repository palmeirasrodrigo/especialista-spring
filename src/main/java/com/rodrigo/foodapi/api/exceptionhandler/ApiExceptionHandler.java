...
import com.rodrigo.foodapi.domain.exception.ValidationException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public static final String MSG_END_USER_GENERIC_ERROR
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex,
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage(MSG_END_USER_GENERIC_ERROR)
                .build();
    ...
    private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult, HttpHeaders headers,
        ...
        List<Problem.Object> problemObjects = bindingResult.getAllErrors().stream()
                .map(objectError -> {
                    String message = messageSource.getMessage(objectError, LocaleContextHolder.getLocale()); // internacionalização messages_pt.properties
