...
public interface UserGroupControllerOpenApi {
    ...
    CollectionModel<GroupResponse> list(@ApiParam(value = "ID do usuário", example = "1", required = true) Long userId);
    ...
    ResponseEntity<Void> disassociate(@ApiParam(value = "ID do usuário", example = "1", required = true) Long userId,
    ...
    ResponseEntity<Void> associate(@ApiParam(value = "ID do usuário", example = "1", required = true) Long userId,
                                   @ApiParam(value = "ID do grupo", example = "1", required = true) Long groupId);
}
