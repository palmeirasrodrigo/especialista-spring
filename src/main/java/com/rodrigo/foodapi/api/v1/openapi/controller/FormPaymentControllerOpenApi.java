...
public interface FormPaymentControllerOpenApi {
    ...
    ResponseEntity<CollectionModel<FormPaymentResponse>> listAll(ServletWebRequest request);
    ...
    ResponseEntity<FormPaymentResponse> find(@ApiParam(value = "ID de uma forma de pagamento", example = "1", required = true) Long formPaymentId, ServletWebRequest request);
